		...
		<div class=" py-5">
			...
			int sum = 0;
					...
					for (int i = 0; i < cartList.size(); i++) { // 상품리스트 하나씩 출력하기
						Phone phone = cartList.get(i);
						int total = phone.getProductPrice() * phone.getQuantity();
						sum = sum + total;
			%>
			<tr>
				<td class="text-center"><em><%=phone.getPhoneName()%> </em></td>
				<td class="text-center"><%=phone.getQuantity()%></td>
				<td class="text-center"><%=phone.getProductPrice()%>원</td>
